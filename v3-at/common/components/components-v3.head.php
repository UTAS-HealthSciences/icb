...
<head>
    ...
    <script src="../vendor/bootstrap-validator/0.4.5/js/bootstrapValidator.min.js" type="text/javascript"></script>
        ...
        <script src="../common/js/dit-component-copy-revision.js"></script>
	...
	.btn-clipboard-active {
        ...
        /*********************************************************************************/
        /*  FOR DEVELOPMENT SITE ONLY                                                    */
        /*                                                                               */
        /*  REMOVE THIS SECTION BEFORE COPYING CODE TO LIVE SITE                         */
        /*                                                                               */
        /*********************************************************************************/
        
        
       /* override default styles for development server */
       /* remove the following six lines (and these comments) when copying to live server */
   #header {
           background: #FF0000;
           background: -webkit-linear-gradient(60deg, #FF0000 55%, #FF0000 45%);
           background: -o-linear-gradient(60deg, #FF0000 55%, #FF0000 45%);
           background: -moz-linear-gradient(60deg, #FF0000 55%, #FF0000 45%);
           background: linear-gradient(60deg, #FF0000 55%, #FF0000 45%);
       }
       /* normal styles set in styles.css (overridden here, but included for reference just in case */
       /*
       #header {
           background: #616363;
           background: -webkit-linear-gradient(60deg, #616363 55%, #666868 45%);
           background: -o-linear-gradient(60deg, #616363 55%, #666868 45%);
           background: -moz-linear-gradient(60deg, #616363 55%, #666868 45%);
           background: linear-gradient(60deg, #616363 55%, #666868 45%);
       }
      */
      /***********************************************************************************/
      /*         END OF DEVELOPMENT SITE STYLE BLOCK                                     */
      /***********************************************************************************/
...
<div id="container"
    ...
    <div id="header"
        ...
        <div class="col-sm-7">
            <h1 class="dit-logo">Digital Innovation Team - Development Version</h1>

            <h2>Interactive Content Builder - <?php echo $style; ?></h2>
