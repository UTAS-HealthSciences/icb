...
require('components/components-v3.head-old.php');
...
function outputComponent($component)
{
    ...
    echo '</div>';
    echo '<hr>';
    echo '<div class="zero-clipboard text-center"><button class="copy-button btn-clipboard">Copy to Clipboard</button></div>';
}
...
echo file_get_contents('components/components-v3.foot-old.html');
?>