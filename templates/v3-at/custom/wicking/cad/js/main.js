...
require.config({
    paths: {
        'domReady': 'https://health.utas.edu.au/templates/wicking/_common/js/domReady',
        'jquery': ["https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min", 'https://health.utas.edu.au/templates/wicking/_common/js/jquery-1.11.1.min'],
        'plugins': 'https://health.utas.edu.au/templates/wicking/_common/js/plugins',
        'bootstrap': 'https://health.utas.edu.au/templates/wicking/_common/js/bootstrap.min',
        'jquery-ui': 'https://health.utas.edu.au/templates/wicking/_common/js/jquery-ui.min',
        'interactive': 'https://health.utas.edu.au/templates/wicking/_common/js/interactive'
    },
    shim: {
        'bootstrap': {
            deps: ['jquery']
...
require(['jquery', 'domReady', 'plugins', 'jquery-ui'], function($, domReady) {
    domReady(function() {
